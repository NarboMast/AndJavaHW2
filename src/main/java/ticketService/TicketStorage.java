...
public class TicketStorage {
    ...
    public TicketStorage() {
        tickets.add(new Ticket("dd01", "1234567890", (short) 123, Timestamp.valueOf("2024-12-20 20:00:00"), PromoStatus.YES, StadiumSector.A, 10.999f, SharedType.PHONE, "PE123456789"));
